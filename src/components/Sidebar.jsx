...
const Sidebar = () => {
    return (
        <div className=" w-[40%] flex">
            <div className=" w-[10%] bg-[#121638] h-[100vh] col-auto justify-items-center ">
                ...
                <div className=" cursor-pointer  hover:bg-[#C61531] p-2">
                    <img
                        src="ri_customer-service-fill@3x.svg"
                        alt=""
                        onClick={""}
                    />
                </div>
                ...
                <div className=" cursor-pointer   hover:bg-[#C61531] p-2">
                    <img
                        src="Agent & broker management@3x.svg"
                        alt=""
                        onClick={""}
                    />
                </div>
            ...
            <div className=" bg-white w-[35%] border  border-red-500 h-[100vh] justify-center items-center">
                <img
                    src="SmallLogo.svg"
                    alt=""
