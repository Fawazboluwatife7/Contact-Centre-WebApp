      ...
      <div className="py-10 mt-8 bg-white min-h-[75%]">
        ...
        <div className="relative w-full max-w-[1163px] h-auto mx-auto bg-white rounded-[5px] p-8">
          ...
          <div className="flex justify-between items-center mt-24">
            {/* Back Button */}
            <button onClick={() => handleNavigate("/ContactPersonPage")} className="w-[196px] h-[56px] border border-[#C61531] rounded-[5px] flex items-center justify-center font-bold text-[18px] text-[#C61531] ml-10">
              Back
            </button>
            {/* Proceed Button */}
            <button onClick={() => handleNavigate("/DependantsPage")} className="w-[196px] h-[56px] bg-[#C61531] rounded-[5px] flex items-center justify-center font-bold text-[18px] text-white mr-5">
              Proceed
            </button>
          </div>
        </div>
