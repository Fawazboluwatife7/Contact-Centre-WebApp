            ...
            <div className="grid grid-cols-4 gap-4 border-b pb-4 mt-4">
              <div>
                ...
                <p className="font-medium text-gray-800">
                  39 Adisa Bashua, Surulere, Lagos, Nigeria.
                </p>
              </div>
              <div>
      ...
      <div className="mt-6 md:grid md:grid-cols-2 grid grid-cols-1 gap-6">
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h4 className="text-lg font-semibold text-gray-800 mb-4 text-center">
            Enrollee Overall Status
          </h4>
          <div className="flex justify-center items-end space-x-6">
            <div
              className="flex flex-col items-center"
              style={{ width: "155.56px", height: "185.53px", gap: "0px" }}
            >
              <div
                className="bg-green-500 w-full rounded-b-xl"
                style={{ height: "100%" }}
              >
            ...
            >
              <div
                className="bg-orange-500 w-full rounded-b-xl"
                style={{ height: "100%" }}
              >
                <p className="ml-14 mt-14 text-white">100%</p>
              </div>
            ...
            >
              <div
                className="bg-blue-500 w-full mt-3 rounded-b-xl"
                style={{ height: "80%" }}
              >
