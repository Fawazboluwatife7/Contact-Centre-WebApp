...
//   const [itemsPerPage, setItemsPerPage] = useState(7);
  ...
  return (
    <div className="bg-lightblue">
      ...
      <div className="ml-6 flex bg-white-500 shadow-md">
        ...
        <div className=" shadow-md ml-auto w-[182px] h-[44px] bg-red-700 text-white rounded flex items-center justify-center">
      ...
      <div className="ml-6 mb-10 w-[1110px] shadow-md ">
