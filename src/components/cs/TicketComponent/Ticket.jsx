      ...
      <div className="min-h-screen bg-white p-8">
        ...
        <div className="flex justify-between mb-4">
          ...
          <div className="flex space-x-4">
            <button
              ...
              className={`w-[142px] h-[43px] text-center py-2 px-4 rounded-md ${
                filter === "All"
                  ? "bg-white text-red-500 border-red-500 border-b-4"
          ...
          <div className="flex space-x-4 ml-auto">
            <button className="flex items-center px-4 py-2 text-red-500 rounded-md">
              ...
              {filteredTickets.map((ticket) => (
                <tr key={ticket.id} className="border-b">
                  ...
                  <td className="px-4 py-2">
                    <button
                      onClick={() => handleNavigate("/ticket-information")}
