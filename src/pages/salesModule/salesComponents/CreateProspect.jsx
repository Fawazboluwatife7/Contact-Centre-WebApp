    ...
    <div className="p-6 bg-gray-200 h-full">
      ...
      <div className="py-8 mt-10 bg-white h-[87%]">
        ...
        <div className="flex justify-center gap-6 mt-12">
          {/* Corporate Card */}
          <div onClick={() => handleNavigate("/CompanyDetailsForm")} className="relative w-72 h-76 bg-white border cursor-pointer border-gray-300 rounded-md shadow-lg flex flex-col items-center py-6 hover:scale-95">
