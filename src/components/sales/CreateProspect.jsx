    ...
    <div className="p-4  h-full">
      ...
      <div className="py-8 mt-10 bg-white h-[87%]">
        ...
        <div className="flex justify-center gap-6 mt-12">
          {/* Corporate Card */}
          <Link to='/SalesDashboard/corporate-client-onboarding1' className="relative w-72 h-76 bg-white border cursor-pointer border-gray-300 rounded-md shadow-lg flex flex-col items-center py-6 hover:scale-95 hover:border-2 hover:border-red-600">
          ...
          <Link to='/SalesDashboard/sme-client-onboarding1'>
            <div className="relative w-72 h-72 bg-white border cursor-pointer border-gray-300 rounded-md shadow-lg flex flex-col items-center py-6 hover:scale-95 hover:border-2 hover:border-red-600">
