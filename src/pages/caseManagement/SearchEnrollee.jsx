                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-black">
                            ...
                            <tbody className=" bg-white ">
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="px-6 py-4">Ajibade Bunmi</td>
                                    <td class="px-6 py-4">LH13738493/0</td>
                                    <td class="px-6 py-4">Magnum</td>
                                    <td class="px-6 py-4">--------</td>
                                    <td class="px-6 py-4">Annually</td>
                                    <td class="px-6 py-4">22 Aug 2022</td>
                                </tr>
                                <tr class="border-b">
                                    <td class="px-4 py-4">
                                        <img
