...
function GeneratePaCode() {
    ...
    const filteredData = data.filter((item) => {
        return (
            ...
            item.enrolleeId
                .toLowerCase()
                .includes(searchEnrolleeId.toLowerCase()) &&
            item.scheme.toLowerCase().includes(searchScheme.toLowerCase()) &&
            item.billingFrequency
                .toLowerCase()
                .includes(searchPlanType.toLowerCase())
        );
    });
    ...
    return (
        <div className="p-5 w-full h-[100vh] bg-lightblue">
            <span className="w-[183px] h-[23px] text-[23px] font-bold mb-6">
                {" "}
                Generate PA Code
            </span>
            <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6 p-5 bg-white rounded-md">
                {/* Search Fields */}
                    ...
                    <div className="flex flex-col border-2 rounded-md">
                        <div className="ml-7">
                            <input
                                ...
                                onChange={(e) =>
                                    setSearchPlanType(e.target.value)
                                }
                            />
                        </div>
                        <div className="absolute left-3 mt-3">
            ...
            <div className="flex justify-end mt-5 mb-2">
                <div className="text-red-700 w-[88px] h-[36px] flex items-center justify-center bg-white border border-red-700 rounded-md">
                    <img
                        src={filter}
                        alt=""
                ...
                <div className="text-red-700 w-[88px] h-[36px] flex items-center justify-center bg-white border border-red-700 ml-2 rounded-md">
                    <img src={sort} alt="" className="w-[20px] h-[20px] mr-1" />{" "}
                    Sort
                </div>
            </div>
                ...
                <table className="w-full text-sm text-gray-600">
                    ...
                    <tbody>
                        {paginateData.map((item) => (
                            ...
                            >
                                <td className="py-2 px-4 flex items-center cursor-pointer">
                                    <img
                                        src={imageicon}
                                        alt=""
