  ...
  return (
    <div className="flex">
      <div className="w-[82px] bg-[#121638] col-auto justify-items-center ">
        ...
        <div className="mt-24 border-t border-gray-200 mt-7 pt-8">
      ...
      <div className="bg-white w-[212] border min-h-screen justify-center items-center">
        ...
        />
        <div
          className="mt-14 flex px-10 cursor-pointer bg-red-600 group hover:bg-[#C61531] p-2"
          onClick={() => handleNavigate("/StaffDashboard")}
        >
          <img src="Dashboard.svg" alt="" className="group-hover:filter group-hover:brightness-0 group-hover:invert" />
          <p className="ml-2 text-black group-hover:text-white">Dashboard</p>
        </div>
        <div
