...
const ClientOnboardingSlide0 = () => {
  ...
  const handleBack = () => {
    navigate("/SalesDashboard/corporate-client-onboarding5"); // Replace with the actual route for the previous page
  };

  const handleProceed = () => {
    navigate("/SalesDashboard/sales-agent"); // Replace with the actual route for the next page
  };
